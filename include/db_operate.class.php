...
abstract class CRUD extends DB_Connect {
	...
	public function setDistinct($s_str) {
		$this->B_LoadDataSet = false;
		$this->S_Distinct = $s_str;
	}
	private function Select() {
		...
		if ($this->S_Distinct!='')
			{
				$s_sql_count = 'SELECT COUNT(DISTINCT '.array_search ( $this->S_Distinct, $this->A_RelationMap ).') AS mycount';
			}else{
