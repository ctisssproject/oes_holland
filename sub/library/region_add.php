...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=RegionAdd"
			enctype="multipart/form-data" target="ajax_submit_frame"
			style="width: 100%" onsubmit="this.submit();parent.parent.Common_OpenLoading();">
		<div class="list out">
			<div class="title">
				<div>添加资料信息</div>
				<div style="height:18px" class="subButton" onclick="regionAddSubmit()">提交</div>
			</div>
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr class="bright">
				<td style="width: 100px"><span>城市</span></td>
				<td class="right_none">
			...
			<tr class="bright">
				...
				<td class="right_none">€ <input id="Vcl_Price" name="Vcl_Price"
					value=""
					type="text" style="width:50px"/> <span class="red">*</span></td>
			</tr>
			<tr class="dark">
			...
			<tr class="dark">
				<td style="vertical-align: top;"><span>景区介绍</span></td>
