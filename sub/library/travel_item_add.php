...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=TravelItemAdd"
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr class="bright">
				...
				<td class="right_none"><input id="Vcl_Name" name="Vcl_Name"
					value="" style="width: 200px" type="text" /> <span class="red">*</span>
				<span class="gray">换行符号为: &lt;br/&gt;</span></td>
			</tr>
		</table>
		<div class="page" style="padding-left: 120px">
		<input type="hidden" name="Vcl_TitleId" id="Vcl_TitleId" value="<?php echo($_GET['titleid'])?>" />
