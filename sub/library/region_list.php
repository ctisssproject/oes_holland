...
<head>
    ...
    <script type="text/javascript">
	 ...
	 function selectCity() { 
		 rightGoTo('region_list.php?cityid='+document.getElementById('city').value+'&typeid='+document.getElementById('type').value)
	 }
    </script>
    ...
    <div align="center">
        <table class="main" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td class="center">
                    <div class="list">
                        <?php echo($o_showpage->RegionList($o_page,$_GET['key']))?>
                    </div>
                </td>
            </tr>
        </table>
