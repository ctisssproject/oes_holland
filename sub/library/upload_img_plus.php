...
$max_width = "900";							// 上传图片的最大宽度
$thumb_width = "532";						// 裁切后小图的初始宽度
$thumb_height = "178";						// 裁切后小图的初始高度
// 以下数组存放允许上传的文件类型
...
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
	...
	<input type="file" name="image" size="30" onchange="document.getElementById('upload').click();"/> <input style="display:none" id="upload" type="submit" name="upload" value="Upload" />
	</form>
<?php } ?>
<script type="text/javascript">
	 $(window).load(function(){resizeLeave1()});
</script>
</body>
</html>
