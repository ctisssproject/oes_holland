...
<form method="post" id="submit_form"
	action="<?php
	echo (RELATIVITY_PATH)?>sub/student/include/bn_submit.svr.php?function=InformationUseForMobile"
    ...
    <div class="forgot_pass_box" style="margin-top:0px;">
		...
		echo ($o_info->getName ())?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo($o_info->getSum())?> 份</h2><!-- 物品名称 -->
                <div class="row">
