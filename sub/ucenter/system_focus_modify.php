...
$o_table = new FocusPhoto ( $_GET ['photoid'] );
if ($o_table->getNumber () > 0) {
} else {
	echo ('<script type="text/javascript">location=\'system_focus.php\';</script>');
	exit ( 0 );
}
?>
...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=SystemFocusModify"
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr class="dark">
				...
				<td class="right_none"><input id="Vcl_Title" name="Vcl_Title"
					value="<?php
					echo ($o_table->getTitle ())?>" style="width: 500px;"
			...
			<tr class="dark">
				...
				echo('<img style="width:710px;height:311px" src="'.$o_table->getPath().'" alt="" />');
				?>				
				</td>
			</tr>
			<tr class="bright">
		...
		<div class="subButton" onclick="systemFocusAddSubmit()">保存</div>
