...
<form method="post" id="submit_form"
	action="<?php
	echo (RELATIVITY_PATH)?>sub/ucenter/include/bn_submit.svr.php?function=CourseChapterMove"
...
<div class="subButton"
	onclick="document.getElementById('submit_form').onsubmit()">确定</div>
</div>
</div>
<input type="hidden" name="Vcl_ChapterId"
	value="<?php
	echo ($_GET ['chapterid'])?>" /></form>
