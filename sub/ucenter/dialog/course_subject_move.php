...
<form method="post" id="submit_form"
	action="<?php
	echo (RELATIVITY_PATH)?>sub/ucenter/include/bn_submit.svr.php?function=CourseSubjectMove"
...
<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="dialog_title" style="font-family: 微软雅黑;">移动到...</td>
		<td style="width: 35px">
...
<table class="TableBlock" style="width: 100%; margin-top: 15px;">
	...
	<?php
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="80">&nbsp;&nbsp;目标节</td>
			<td class="TableData"><div id="section"><select name="Vcl_SectionId" id="Vcl_SectionId"
				class="BigSelect"><option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
				</select></div></td>
		</tr>
	</tbody>
...
<div class="subButton"
	onclick="courseSubjectMoveAndCopySubmit()">确定</div>
</div>
</div>
