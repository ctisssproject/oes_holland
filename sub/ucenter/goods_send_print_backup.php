...
<body>
<div style="top:37px;left:90px;"></div>
<div style="top:37px;left:247px;"></div>
<div style="top:68px;left:60px;"></div>
...
<div style="left:50px;top:160px;"></div>
<div style="left:232px;top:171px;"></div>
<div style="left:450px;top:37px;width:100px"><?php echo($o_send->getName())?></div>
<div style="top:37px;left:607px;width:100px"><?php echo($s_mudidi)?></div>
<div style="top:68px;left:420px;width:330px"><?php echo($o_user->getCompany())?>-<?php echo($o_user->getDept())?></div>
<div style="top:96px;left:368px;width:330px;vertical-align:top;line-height:32px">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo($o_send->getAddress())?> </div>
<div style="left:400px;top:160px;width:200px"><?php echo($o_send->getPhone())?></div>
