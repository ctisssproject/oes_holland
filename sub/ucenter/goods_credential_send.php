...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=GoodsCredentialSend"
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr class="bright">
				...
				<td class="right_none"><input id="Vcl_OrderNumber"
					name="Vcl_OrderNumber" maxlength="200" value=""
					style="width: 240px;" type="text" /> <span class="red">*</span></td>
			</tr>
		</table>
		...
		<input type="hidden" name="Vcl_Id" value="<?php
		echo ($_GET ['id'])?>" />
		</form>
		</td>
	</tr>
