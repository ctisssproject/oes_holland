...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=SystemNewsAdd"
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr class="bright">
				...
				<td class="right_none"><input id="Vcl_Title" name="Vcl_Title"
					value="" style="width: 400px" type="text" /> <span class="red">*</span></td>
			</tr>
			<tr class="dark">
		...
		<div class="subButton" onclick="systemNewsAddSubmit()">提交</div>
