...
$o_table = new Partners ( $_GET ['partnerid'] );
if ($o_table->getNumber () > 0) {
} else {
	echo ('<script type="text/javascript">location=\'system_partners.php\';</script>');
	exit ( 0 );
}
?>
...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=SystemPartnersModify"
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr class="bright">
				...
				echo('<img src="'.$o_table->getIcon().'" alt="" />');
				?>				
				</td>
			</tr>
			<tr class="dark">
		...
		<input type="hidden" name="Vcl_PartnerId"
			value="<?php
			echo ($_GET ['partnerid'])?>" /></form>
		</td>
	</tr>
</table>
</div>
