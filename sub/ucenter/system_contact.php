...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<form method="post" id="submit_form"
			action="include/bn_submit.svr.php?function=SystemContactModify"
		...
		<div class="title">
		<div>修改联系我们</div>
		<div class="subButton" onclick="window.open('../../contact.php','_blank')">预览</div>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr class="dark">
				<td style="width: 100px; vertical-align: top;"><span>正文</span></td>
				<td class="right_none">
				<script id="editor" type="text/plain"><?php 
				$o_system=new System(1);
				echo($o_system->getContact());
				?></script>
				</td>
			</tr>
		</table>
