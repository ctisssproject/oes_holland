...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td class="center">
		<div class="list out">
		<div class="title"><div>资料发货信息</div></div>
		<table border="0" cellpadding="0" cellspacing="0">
			<tr class="dark">
				<td style="width: 100px"><span>领用时间</span></td>
			...
			<tr class="dark">
				...
				<td class="right_none"><?php echo($o_table->getLogistic())?>
				</td>
			</tr>
			<tr class="bright">
		...
		<div class="subButton" onclick="openPrint(<?php echo($_GET ['useid'] )?>)">打印</div>
