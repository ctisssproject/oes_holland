...
<table class="main" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		echo ($o_showpage->getTop ( 'title_prize', $o_user ))?>
		<table class="prize" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				for($i = 0; $i < $n_count; $i ++) {
					$s_button = '<div class="right" align="center" title="点击兑换奖品" onclick="Dialog_Iframe(\'dialog/prize_exchange.php?prizeid=' . $o_prize->getPrizeId ( $i ) . '\',252,418)">
							马上兑换
						</div>';
					if ($o_prize->getSum ($i) == 0) {
						$s_button = '<div class="right off" align="center">
							兑换结束
						</div>';
					}
					echo ('
