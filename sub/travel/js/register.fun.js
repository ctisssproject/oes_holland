...
function registerSubmit()
{
    ...
    if (B_Vcl_UserName==false||B_Vcl_Sex==false||B_Vcl_Password==false||B_Vcl_Password2==false || B_Vcl_ValidCode==false||B_Vcl_Phone==false)
    {
        Dialog_Message("请将 * 标记的信息填写完整后提交！")
        return
    }
    document.getElementById('Vcl_UserName').value=document.getElementById('Vcl_UserName').value+'@qq.com'
...
function findPasswordSubmit()
{
    ...
    if (B_Vcl_UserName_F==false||B_Vcl_ValidCode==false|| B_Vcl_TelePhone==false)
    {
